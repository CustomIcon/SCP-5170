...
async def _(_, query: bot.types.InlineQuery):
    ...
    if isinstance(u, user.types.Chat):
        ...
        text = user.md.Section(
            'UserInfo:',
            user.md.SubSection(
                user.md.KeyValueItem(key='name', value=u.first_name + ' ' + (u.last_name or '')),
            user.md.KeyValueItem(user.md.Bold('user_id'), user.md.Code(u.id)),
            user.md.KeyValueItem(user.md.Bold('is_contact'), user.md.Code(u.is_contact)),
            user.md.KeyValueItem(user.md.Bold('username'), user.md.Code(name_check(u.username))),
